object Kotlin {
    ...
    const val coroutines_core = "org.jetbrains.kotlinx:kotlinx-coroutines-core:${Version.kotlin}"
    const val coroutines = "org.jetbrains.kotlinx:kotlinx-coroutines-android:${Version.kotlin}"
}
